  ...
  return (
    <LampContainer>
      <motion.h2
        ...
        viewport={{ once: true }}
        className="bg-gradient-to-b from-primary via-primary to-black py-4 bg-clip-text text-center text-4xl font-medium uppercase font-clash tracking-wide text-transparent md:text-7xl"
      >
        Hizmetlerimiz
      </motion.h2>
    </LampContainer>
...
export const LampContainer = ({ children, className }) => {
  return (
    <div
      className={cn(
        "relative flex min-h-[250px] md:min-h-[400px] flex-col items-center justify-center overflow-hidden bg-black w-full rounded-md z-0",
        className
      )}
    >
      ...
      <div className="relative z-50 flex -translate-y-16 md:-translate-y-36 flex-col items-center px-5">
        {children}
      </div>
    </div>
  )
